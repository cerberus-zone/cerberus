...
import (
	...
	"github.com/windpowerstake/cerberus/app"
	"github.com/windpowerstake/cerberus/app/params"
	"github.com/CosmWasm/wasmd/x/wasm"
	wasmkeeper "github.com/CosmWasm/wasmd/x/wasm/keeper"
	wasmtypes "github.com/CosmWasm/wasmd/x/wasm/types"
)

// NewRootCmd creates a new root command for cerberusd. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	rootCmd := &cobra.Command{
		Use:   version.AppName,
		Short: "Cerberus is a three head dog",
